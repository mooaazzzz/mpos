...
//            printExample(context);
     ...
     */
    public void printExample(Context context, List<DataModel> dataResponse, String merchant_copy) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
        try {
            ...
            sunmiPrinterService.printTextWithFont("E&E Enterprises\n", null, 40, null);
            sunmiPrinterService.printTextWithFont("Booking Qube\n", null, 40, null);
            sunmiPrinterService.printTextWithFont("Ticketing Partner\n", null, 25, null);
//            Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.img_booket_final_resize);
//            sunmiPrinterService.printBitmap(bitmap, null);
            ...
            sunmiPrinterService.printTextWithFont("Play area\n",
                    null, 12, null);
            if (paper == 1) {
                sunmiPrinterService.printText("--------------------------------\n", null);
            } else {
            ...
            String txts[] = new String[]{"Location", dataResponse.get(0).getLocation()};
            int width[] = new int[]{1, 1};
            int width1[] = new int[]{1, 1, 2};
            ...
            txts[0] = "Payment Source";
            txts[1] = dataResponse.get(0).getPaymentSource();
            sunmiPrinterService.printColumnsString(txts, width, align, null);
            txts[0] = "Customer Phone";
            txts[1] = dataResponse.get(0).getCustomerPhone();
            sunmiPrinterService.printColumnsString(txts, width, align, null);
            txts[0] = "Customer Name";
            txts[1] = dataResponse.get(0).getCustomerName();
            sunmiPrinterService.printColumnsString(txts, width, align, null);
            ...
            for (DataModel dataModel : dataResponse) {
                txts[0] = "Ride Name";
                txts[1] = dataModel.getRideName();
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Duration";
                txts[1] = dataModel.getDuration();
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Paid for ride";
                txts[1] = dataModel.getTotalPaid();
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Barcode";
                txts[1] = dataModel.getBarcode();
                sunmiPrinterService.printColumnsString(txts, width, align, null);

//                txts[0] = "Check In";
//                txts[1] = dataModel.getCheckIn();
                sunmiPrinterService.printColumnsString(new String[]{"Check In","",dataModel.getCheckIn()}, width1, align1, null);
//                sunmiPrinterService.printTextWithFont(txts[0], null, 20, null);
//                sunmiPrinterService.printColumnsString(txts, width, align, null);

//                txts[0] = "Check Out";
//                txts[1] = dataModel.getCheckOut();
                sunmiPrinterService.printColumnsString(new String[]{"Check Out","",dataModel.getCheckOut()}, width1, align1, null);
//                sunmiPrinterService.printTextWithFont(txts[0], null, 20, null);

                sunmiPrinterService.printBarCode(dataModel.getBarcode(), 8, 162, 2, 2, null);
//                sunmiPrinterService.printBarCode(dataModel.getBarcode(), 4, 300, 150, 150, null);
                if (paper == 1) {
                    sunmiPrinterService.printText("--------------------------------\n", null);
                } else {
                    sunmiPrinterService.printText("------------------------------------------------\n",
...
//            txts[0] = "Currency";
//            txts[1] = dataResponse.get(0).getCurrency();
//            sunmiPrinterService.printColumnsString(txts, width, align, null);
...
//            }
            sunmiPrinterService.setAlignment(0, null);
            sunmiPrinterService.printTextWithFont("Total Tickets:" , "", 30, null);
            sunmiPrinterService.setAlignment(2, null);
            sunmiPrinterService.printTextWithFont(dataResponse.get(0).getFinalTicket(), "", 30, null);

            sunmiPrinterService.setAlignment(0, null);
            sunmiPrinterService.printTextWithFont("Total Amount:" , "", 30, null);
            sunmiPrinterService.setAlignment(2, null);
            sunmiPrinterService.printTextWithFont(dataResponse.get(0).getFinalPaid(), "", 30, null);
    ...
    public void printDayClosing(List<DayClosing> dataResponse, String merchant_copy) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
...
//            sunmiPrinterService.printBitmap(bitmap, null);
            ...
            for (int i = 0; i < dataResponse.size(); i++) {
                String txts[] = new String[]{"Location", dataResponse.get(i).getLocation()};
                int width[] = new int[]{1, 1};
                int align[] = new int[]{0, 2};
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                try {
...
//                txts[0] = "Location";
//                txts[1] = dataResponse.get(i).getLocation();
//                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Agent Name";
                txts[1] = dataResponse.get(i).getAgentName();
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Cash Received";
                txts[1] = dataResponse.get(i).getCashReceived().replace("-", "—");
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = "Credit Received";
                txts[1] = dataResponse.get(i).getCreditReceived().replace("-", "—");
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = "Debit Received";
                txts[1] = dataResponse.get(i).getDebitReceived().replace("-", "—");
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                if (paper == 1) {
                    sunmiPrinterService.printText("--------------------------------\n", null);
                } else {
                ...
                txts[0] = "Shortage Cash";
                txts[1] = dataResponse.get(i).getShortageCash().replace("-", "—");
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = "Shortage Credit";
                txts[1] = dataResponse.get(i).getShortageCredit().replace("-", "—");
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Shortage Debit";
                txts[1] = dataResponse.get(i).getShortageDebit().replace("-", "—");
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                if (paper == 1) {
                    sunmiPrinterService.printText("--------------------------------\n", null);
                } else {
...
//                txts[0] = "retMsg";
//                txts[1] = dataResponse.get(i).getRetMsg();
//                sunmiPrinterService.printColumnsString(txts, width, align1, null);
                try {
                    sunmiPrinterService.setPrinterStyle(WoyouConsts.ENABLE_BOLD, WoyouConsts.ENABLE);
                } catch (RemoteException e) {
                    sunmiPrinterService.sendRAWData(ESCUtil.boldOn(), null);
                ...
                txts[0] = "tranNo";
                txts[1] = String.valueOf(dataResponse.get(i).getTranNo());
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Close Date";
                txts[1] = String.valueOf(dataResponse.get(i).getCloseDate());
                sunmiPrinterService.printColumnsString(txts, width, align, null);
...
//            sunmiPrinterService.printTextWithFont("Total:         " + dataResponse.get(i).getTotalPaid() + "\b", null, 30, null);
//            sunmiPrinterService.setAlignment(1, null);
//            sunmiPrinterService.printBarCode(dataResponse.get(i).getBarcode(), 8, 600, 300, 300, null);
            }
            sunmiPrinterService.setFontSize(26, null);
            sunmiPrinterService.printText("\n" + merchant_copy, null);
            sunmiPrinterService.autoOutPaper(null);
    ...
    public void printSearch(List<Search> dataResponse, String merchant_copy) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
...
//            sunmiPrinterService.printBitmap(bitmap, null);
            ...
            for (int i = 0; i < dataResponse.size(); i++) {
                String txts[] = new String[]{"Ride Name", dataResponse.get(i).getRideName()};
                int width[] = new int[]{1, 1};
                int align[] = new int[]{0, 2};
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                try {
                ...
                txts[0] = "Duration";
                txts[1] = dataResponse.get(i).getDuration();
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Barcode";
                txts[1] = dataResponse.get(i).getBarcode();
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Total Paid";
                txts[1] = dataResponse.get(i).getTotalPaid();
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = "Payment Source";
                txts[1] = dataResponse.get(i).getPaymentSource();
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = "Customer Name";
                txts[1] = dataResponse.get(i).getCustomerName();
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = "Customer Email";
                txts[1] = dataResponse.get(i).getCustomerEmail();
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = "Customer Phone";
                txts[1] = dataResponse.get(i).getCustomerPhone();
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Logged By";
                txts[1] = dataResponse.get(i).getLoggedBy();
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "Time";
                txts[1] = dataResponse.get(i).getTransactionTime();
                sunmiPrinterService.printColumnsString(txts, width, align, null);

                txts[0] = "No of Tickets";
                txts[1] = String.valueOf(dataResponse.get(i).getNoOfTickets());
                sunmiPrinterService.printColumnsString(txts, width, align, null);
    ...
    public void printSearchSingle(List<Search> dataResponse, String merchant_copy, int i) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
